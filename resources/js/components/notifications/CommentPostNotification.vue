        ...
        <div class="col-9 col-md-9">
            <div class="row-list-user-display">
                ...
                <div class="list-data-user">
                    <p v-if="commenter != null" class="row-user-date" style="display: block ruby">
...
<script>
    ...
    export default {
        ...
        computed: {
            text: function () {
                return this.reply ? this.lang.NOTIFICATIONS.USER_COMMENTED_YOUR_COMMENT : this.lang.NOTIFICATIONS.USER_COMMENTED_YOUR_POST;
