        ...
        computed: {
            text: function () {
                ...
                if (this.voter.metadata && this.voter.metadata.publicName) {
                    return String.format(t, this.voter.metadata.publicName, this.discussion.permlink, this.discussion.title);
                } else {
                    return String.format(t, this.voter.name, this.discussion.permlink, this.discussion.title);
                }
            }
        },
        data: function () {
