...
<div class="new-profile">
    ...
    <div class="container date-profile">
            ...
            <div class="col-12">
                <div class="box-user-avatar">
                    ...
                    <div class="img-user-avatar-profile"
                        style="background-image: url('https://ipfs.creary.net/ipfs/QmUhcxJVysx733PJgHx6RKowApjMsoG8cqC92CWvZiiaXP');">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-12 text-right">
                <a href="" class="mr-3 bloquear">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="Grupo_9765"
                        data-name="Grupo 9765" width="25.112" height="21.656" viewBox="0 0 25.112 21.656">
                        <defs>
        ...
        <div class="row row-content">
            ...
            <div class="col-12 col-md-6 col-xl-3">
                <p class="title-progress">CREA Energy: <strong class="ml-2">3894.<span
                            class="sat">033</span>CREA</strong> <img class="ml-2" style="width: 15px;"
                        src="https://design.creary.net/img/wallet/creary-cgy-logo.svg" alt=""></p>
                <div class="energy">
