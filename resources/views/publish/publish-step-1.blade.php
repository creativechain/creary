<div class="step-1">
    <div class="boxed boxed--border">
        <div v-if="bodyElements.length === 0 && !editor.show" class="section-title-step">
            <h4 class="title-steps">{{ __('lang.PUBLISH.SECONDARY_MENU_CONTENT') }}</h4>
            <span class="description-step-title">{{ __('lang.PUBLISH.CONTENT_SUBTITLE') }}</span>
        </div>
        ...
        <div class="box-content-step-1">
            <div v-if="editor.show" class="section-editor">
                <div class="section-title-step upload-img">
                    <h4 class="title-steps">{{ __('lang.PUBLISH.CONTENT_TEXT') }}</h4>
                    <span class="description-step-title">{{ __('lang.PUBLISH.CONTENT_SECONDARY_SENTENCE') }}</span>
                </div>
            ...
            <div v-if="editor.show" class="row mt-3 justify-content-end" style="z-index: 1;position: relative;">
                ...
                <div class="col-6 col-md-4 col-lg-3 text-center">
                    <div class="btn btn--sm btn--primary"  v-on:click="updateText(updatingIndex)">
                        <span class="btn__text">{{ __('lang.BUTTON.SAVE') }}</span>
                    </div>
                </div>
            </div>
            ...
            <div>
                <div class="col-md-12">
                    <p class="disabled mb-0">
                        @{{ String.format(lang.PUBLISH.IMAGE_MAX_FILE_SIZE, humanFileSize(CONSTANTS.FILE_MAX_SIZE.POST_BODY.IMAGE), humanFileSize(CONSTANTS.FILE_MAX_SIZE.POST_BODY.GIF)) }},
