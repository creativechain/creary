<div class="step-2">
    <div class="boxed boxed--border">
        ...
        <div class="boxed boxed--border box-image-step-2" v-on:click="loadFeaturedImage">
            <div class="">
                <div v-if="!featuredImage.url" class="col-md-6 offset-md-3 col-sm-12 text-center" style="position: relative;top: 60px;">
                    <img v-lazy="'{{ asset('img/crea-web/publish/b-img-portada.png') }}'" alt="" />
                    <p>{{ __('lang.PUBLISH.INFO_IMAGE') }}</p>
                    <p class="disabled">@{{ String.format(lang.PUBLISH.IMAGE_MAX_FILE_SIZE, humanFileSize(CONSTANTS.FILE_MAX_SIZE.POST_PREVIEW.IMAGE), humanFileSize(CONSTANTS.FILE_MAX_SIZE.POST_PREVIEW.GIF)) }}</p>
                </div>
