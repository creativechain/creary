            ...
            <div class="row">
                <div class="col-md-12 row-flex">
                    ...
                    <div class="col-info-user">
                        ...
                        <input id="profile-edit-input-avatar" class="hidden" type="file" accept="image/*"
                            v-on:change="onLoadAvatar" />
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-3">
                    ...
                    <input class="validate-required" type="text" v-bind:maxlength="CONSTANTS.TEXT_MAX_SIZE.PROFILE.WEB"
                        v-model="profile.web" placeholder="{{ __('lang.EDIT_PROFILE.INPUT_WEBSITE') }}" />
                </div>
            </div>
            <div class="row">
                <div class="col-12">
