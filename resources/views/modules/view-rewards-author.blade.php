<div class="w-100">
    <h3 class="title-section-profile">{{ __('lang.PROFILE.TITLE_AUTHOR') }}</h3>
</div>
<div class="w-100">
    <div class="boxed boxed--border box-rewards-autor">
        <div class="row">
            <div class="col">
                <p>{{ __('lang.PROFILE.TEXT_AUTHOR') }}:</p>
            </div>
...
<div class="w-100">
    <h3 class="title-section-profile">{{ __('lang.PROFILE.TITLE_AUTHOR_HISTORY') }}</h3>
</div>
            ...
            <div class="col-md-12">
                <table class="table">
                    ...
                    <tr v-for="t in rewardsOp">
                        ...
                        <td>@{{ t[1].op[1].cbd_payout }}, @{{ t[1].op[1].crea_payout }} {{ __('lang.COMMON.AND') }} @{{ vestsToCgy(t[1].op[1].vesting_payout).toFriendlyString() }} {{ __('lang.COMMON.FOR') }} @{{ "@" + t[1].op[1].author + "/" + t[1].op[1].permlink }}</td>
                    </tr>
                    </tbody>
                </table>
            </div>
