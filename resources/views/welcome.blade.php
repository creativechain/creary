...
@section('content')
    <div v-cloak id="welcome" class="main-container view-welcome">
                        ...
                        <div class="welcome-content">
                            ...
                            <div class="row">
                                <div class="col-lg-10 offset-lg-1 col-md-12 text-center row-inputs">
                                    <input ref="inputusername" v-on:input="checkUsername" v-bind:class="{ 'validate-required': true, 'field-error': error.username && error.username.length > 0 }" type="text" placeholder="{{ __('lang.WELCOME.SLIDE2_INPUT_PLACEHOLDER') }}" />
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <div class="welcome-content">
                            ...
                            <div class="row">
                                <div class="col-lg-10 offset-lg-1 col-md-12 text-center row-inputs">
                                    <input id="reg-email" type="email" v-on:input="checkEmail" v-bind:class="{ 'validate-required': true, 'field-error': error.email && error.email.length > 0 }" placeholder="{{ __('lang.WELCOME.SLIDE3_INPUT_PLACEHOLDER') }}" />
        ...
        <section v-bind:class="{ hidden: slide !== 6, imageblock: true, switchable: true, 'height-100': true }">
            <div class="imageblock__content col-lg-6 col-md-6 col-sm-12 pos-right">
                <div class="background-image-holder">
                    <img alt="image" src="/img/welcome/creary_slide_6-sms.jpg" class="logo-welcome" />
                </div>
            </div>
            <div class="container pos-vertical-center content-slide-welcome ">
                <div class="row">
